...
function getPokemonWeakeanes(types) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    let weakness2
    if (types.type2) weakness2 = yield axios_1.default.get(types.type2)
    ...
    const finalWeak = {
      damageDoubleFrom: (0, mergeObjc_1.mergeObjc)(
        pokeWeak1.damageDoubleFrom,
        pokeWeak2.damageDoubleFrom,
      ),
      damageDoubleTo: (0, mergeObjc_1.mergeObjc)(
        pokeWeak1.damageDoubleTo,
        pokeWeak2.damageDoubleTo,
      ),
      halfDamageFrom: (0, mergeObjc_1.mergeObjc)(
        pokeWeak1.halfDamageFrom,
        pokeWeak2.halfDamageFrom,
      ),
      halfDamageTo: (0, mergeObjc_1.mergeObjc)(
        pokeWeak1.halfDamageTo,
        pokeWeak2.halfDamageTo,
      ),
      noDamageFrom: (0, mergeObjc_1.mergeObjc)(
        pokeWeak1.noDamageFrom,
        pokeWeak2.noDamageFrom,
      ),
      noDamegeTo: (0, mergeObjc_1.mergeObjc)(
        pokeWeak1.noDamegeTo,
        pokeWeak2.noDamegeTo,
      ),
    }
    return finalWeak
  })
